...
class TestMRC:
    ...
    def test_load_hspy(self):
        filename = os.path.join(tomotools_path, "test_data", "HAADF.mrc")
    ...
    def test_load_dm(self):
        filename = os.path.join(tomotools_path, "test_data", "HAADF.dm3")
        stack = tomotools.load(filename)
        assert stack.axes_manager[0].name == 'Tilt'
    ...
    def test_load_unknown(self):
        filename = os.path.join(tomotools_path, "test_data", "HAADF.NONE")
